...
public class TipoReferenciaComercialDTO implements Serializable {
    ...
    public TipoReferenciaComercialDTO(){
    }

    public TipoReferenciaComercialDTO(Long id, String codigo, String nombre, String codCobis, String codPCIE, Date fechaHoraCrea, Date fechaHoraModifica, String usuarioCrea, String usuarioModifica) {
        this.id = id;
        this.codigo = codigo;
        this.nombre = nombre;
    ...
    public String toString() {
        return "CtgTipoReferenciaComercialDTO{" +
                "id=" + id +
                ", codigo='" + codigo + '\'' +
                ", nombre='" + nombre + '\'' +
                ", codCobis='" + codCobis + '\'' +
