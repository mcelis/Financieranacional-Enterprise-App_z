...
public class TipoEstadoFinancieroDTO implements Serializable {
    ...
    public TipoEstadoFinancieroDTO(){
    }

    public TipoEstadoFinancieroDTO(Integer id, String nombre, Timestamp fechaHoraCrea, Timestamp fechaHoraModifica, String usuarioCrea, String usuarioModifica) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "TipoEstadoFinancieroDTO{" +
                "id=" + id +
                ", nombre='" + nombre + '\'' +
