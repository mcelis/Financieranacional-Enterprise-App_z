...
public class TipoViviendaDTO {
    ...
    public TipoViviendaDTO(Long id, String codigo, String nombre, String codCobis, String codPCIE, Timestamp fechaHoraCrea, Timestamp fechaHoraModifica, String usuarioCrea, String usuarioModifica) {
        this.id = id;
        this.codigo = codigo;
        this.nombre = nombre;
