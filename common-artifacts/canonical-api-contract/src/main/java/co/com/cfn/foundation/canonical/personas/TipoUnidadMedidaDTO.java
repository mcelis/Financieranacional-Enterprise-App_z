...
public class TipoUnidadMedidaDTO implements Serializable{
    ...
    public TipoUnidadMedidaDTO(Integer id, String nombre, Timestamp fechaHoraCrea, Timestamp fechaHoraModifica, String usuarioCrea, String usuarioModifica) {
        this.id = id;
        this.nombre = nombre;
