...
public class GeneroDTO implements Serializable {
    ...
    public GeneroDTO(Integer id, String codigo, String nombre, String codCobis, String codPCIE, Date fechaHoraCrea, Date fechaHoraModifica, String usuarioCrea, String usuarioModifica) {
        this.id = id;
        this.codigo = codigo;
        this.nombre = nombre;
